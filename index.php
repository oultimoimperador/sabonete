...
<div class="dinner menu-restaurant">
            <span class="clearfix">
              <a class="menu-title" href="#" data-meal-img="assets/img/restaurant/rib.jpg">Rum</a>
              <span style="left: 166px; right: 44px;" class="menu-line"></span>
...
<div class="dinner menu-restaurant">
            <span class="clearfix">
              <a class="menu-title" href="#" data-meal-img="assets/img/restaurant/rib.jpg">Uisque</a>
              <span style="left: 166px; right: 44px;" class="menu-line"></span>
          ...
          <div class="dinner menu-restaurant">
            <span class="clearfix">
              <a class="menu-title" href="#" data-meal-img="assets/img/restaurant/rib.jpg">Vodka</a>
              <span style="left: 166px; right: 44px;" class="menu-line"></span>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-12" style="padding-bottom:60px;">
            ...
            <div class="row">
              <div class="col-md-60 col-sm-6 left-images">
                <img src="img/res04.jpg" class="img-responsive" >
              </div>
              <div class="col-md-6 col-sm-6 details-text">
                <div class="content-holder">
                  <h2>Petiscos</h2>
    ...
    <div class="row msg-row">
      ...
      <div class="col-md-8 col-sm-8">
        <form action="" method="post" role="form" class="contactForm">
          ...
          <div class="col-md-6 col-sm-6 contact-form">
            <div class="form-group">
              <input type="text" class="form-control label-floating is-empty" name="people" id="people" placeholder="--------" data-rule="required" data-msg="This field is required" />
              <div class="validation"></div>
            </div>
          </div>
